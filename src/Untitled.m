...
if exist(fileName, 'file') ~= 2
    ...
    [x,y] = size(tempData);
    for i = 1:x % ignore the last 4 rows containing sensor data for Myo_Pose_left,Myo_Pose_Right,Kinect_pose_left,Kinect_pose_right
...
attributeheaders = attributeheaders(1,nAttributes);
data = {};
...
i = 3;
%data =  horzcat(data,num2cell(zeros(nAttributes,M)));
